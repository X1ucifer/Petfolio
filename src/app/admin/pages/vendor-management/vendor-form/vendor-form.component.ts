...
export class VendorFormComponent implements OnInit {
  ...
  addVendor() {
    ...
    if (this.businessname != undefined && this.businessname != '' && this.businessemail != undefined && this.businessemail != '' && this.Completionarray.length > 0 && this.Specarray.length  > 0 && this.address != undefined && this.address != '' && this.address && this.img.length > 0) {
