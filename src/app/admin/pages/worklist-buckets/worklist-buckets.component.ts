...
@Component({
  selector: 'app-worklist-buckets',
  templateUrl: './worklist-buckets.component.html',
  styleUrls: ['./worklist-buckets.component.css']
})
export class WorklistBucketsComponent implements OnInit {
  rows = [];
  searchQR: any;
  value1: any;
  final_data : any;
  ...
  move_to_select(item){
    ...
    this.router.navigateByUrl('/admin_panel/worklist_recordlist');
  }
