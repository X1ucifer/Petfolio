...
@Component({
  selector: 'app-sp-specialization',
  templateUrl: './sp-specialization.component.html',
  styleUrls: ['./sp-specialization.component.css']
})
export class SpSpecializationComponent implements OnInit {
