...
@Component({
  selector: 'app-vendo-side-bar',
  templateUrl: './vendo-side-bar.component.html',
  styleUrls: ['./vendo-side-bar.component.css']
})
export class VendoSideBarComponent implements OnInit {
